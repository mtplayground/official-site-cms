...
export function HeroSection() {
  ...
  return (
    <section ref={rootRef} className="relative overflow-hidden px-4 pb-10 pt-14 sm:px-6 sm:pt-20 lg:pt-24">
      ...
      <div className="relative mx-auto max-w-6xl">
        <div
          className={cn(
            "max-w-3xl transition-all duration-700 ease-out motion-reduce:transform-none motion-reduce:transition-none",
            isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0 motion-reduce:opacity-100",
          )}
        >
